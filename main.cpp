	...
	if (type == 1)
	{
		...
		while (true)
		{
			...
			else if (option == 7)
			{
				...
				{
					cout << endl
						 << "*******An Error occured. Check your input!!!*******" << endl;
				}
			}
...
void loadData()
{
	...
	if (membersFile.is_open())
	{
		...
		while (getline(membersFile, record))
		{
			...
			{
				cout << endl
					 << "*******Error occured. Check the Member record.*******" << endl;
				break;
			}
		}
		membersFile.close();
	...
	if (booksFile.is_open())
	{
		...
		while (getline(booksFile, record))
		{
			...
			{
				cout << endl
					 << "*******Error occured. Check the book record.*******" << endl;
			}
		}
		booksFile.close();
	}
	...
	{
		cout << endl
			 << "*******Unable to open file: books.txt*******" << endl;
	}
	...
	{
		cout << endl
			 << "Unable to open file: issued_books.txt" << endl;
	}
}
